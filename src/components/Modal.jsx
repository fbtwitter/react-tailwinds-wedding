...
const Modal = ({ modalIsOpen, setModalIsOpen }) => {
  ...
  return (
    ...
    >
      <div className="modal grid items-stretch w-screen bg-white/90 shadow text-black min-h-[50vh] rounded-lg relative max-w-sm">
        <div className="p-6">
          <button
          ...
          <header className="flex flex-col justify-center items-center gap-2">
            <h2 className="font-['Dancing_Script'] font-semibold text-2xl text-teal-800">
              Tulis Pesan
            </h2>
            ...
            <form className="pr-6 pl-6" onSubmit={handleSubmit(onSubmit)}>
              <div className="flex flex-col mt-4">
                <label
                  ...
                  className="text-left mb-2 font-['Raleway'] text-sm"
                >
                  Nama
                </label>
                <input
                  id={`${id}-namaLengkap`}
                  type="text"
                  className="w-full p-3 text-sm bg-white border focus:outline-none focus:border focus:border-slate-800 focus-within:outline-none focus-within:border focus-within:border-slate-800"
              ...
              <div className="mt-8">
                <button
                  className="cursor-pointer border-0 text-white py-3 px-11 font-medium text-center transition-all bg-teal-700 w-full"
                  type="submit"
